...
The captured data sets are split by the owning company.
In the following subsections each data set is described in detail including both captured share prices and tweets.
