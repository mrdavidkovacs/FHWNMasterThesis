...
Fourth, the various time series are compared to the corresponding share price time series in \cref{s:analysis-granger}.
...
This timeframe has been chosen in order to be long enough to perform analysis and to finish the study within time.
...
We can see that in total the count of significant values is always around $10 \pm 3$ which corresponds to \SI{25}{\percent} per lag.
