...
As the official search \ac{API} proved to be insufficient as there are some understandably limits in place the DMI TCAT approach was a good decision.
But using DMI TCAT had also some serious drawbacks:

\begin{itemize}
    \item 
        The software must be installed by one self and the machine must be up and running to collect tweets.
        As we can't keep the personal computer running continuously for more than one month we decided to install DMI TCAT to a virtual machine in the cloud.
        ...
        \begin{itemize}
            ...
            \item 
                New DMI TCAT releases have been published which required a database upgrade.
    ...
    \item
        DMI TCAT uses also the official Twitter \ac{API} and as a result some limits apply.
...
First, the issues with the installation and maintenance of DMI TCAT need to be solved.
