...
\begin{description}
  ...
  \item [Estimators.]
    ...
    A model is initialized with specific parameters regarding the specific task.
...
In the following sections each part of the pipeline is described.

% Cross validation with GridSearchCV

\subsection{Count Vectorizer}
\label{ss:casestudy-sentiment-countvectorizer}

\subsection{Term Frequency Inverse Document Frequency Transformer}
\label{ss:casestudy-sentiment-tfidftransformer}

\subsection{Classifier}
\label{ss:casestudy-sentiment-classifier}

\subsubsection{TextBlob Classifier}
\label{sss:casestudy-sentiment-classifier-textblob}

\subsubsection{Naive Bayes Classifier}
\label{sss:casestudy-sentiment-classifier-naivebayes}

\subsubsection{Maximum Entropy Classifier}
\label{sss:casestudy-sentiment-classifier-maximumentropy}

\subsubsection{Support Vector Machine Classifier}
\label{sss:casestudy-sentiment-classifier-supportvector}
