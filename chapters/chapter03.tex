...
\begin{description}
  ...
  \item[Term Frequency Inverse Document Frequency Transformer]
    ...
    \begin{table}
      ...
      \caption{Hyper-parameters of the Term Frequency Inverse Document Frequency Transformer}
  ...
  \item[Classifier]
    ...
    \begin{description}
      \item[TextBlob Classifier]
        ...
        The only effort made was to make the TextBlob classifier available to the scikit-learn package and implement the estimator interface (the method \emph{predict}).
