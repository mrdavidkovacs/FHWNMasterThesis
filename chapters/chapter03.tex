...
The sentiments were detected using four different models using the same workflow depicted in \cref{fig:casestudy-sentimentworkflow} and the used symbols are described in \cref{tab:casestudy-sentimentvariables}.
...
In the following sections each model will be illustrated.
...
\label{ss:casestudy-sentiment-textblob}



\subsection{Naive Bayes Classifier}
\label{ss:casestudy-sentiment-naivebayes}

\subsection{Maximum Entropy Classifier}
\label{ss:casestudy-sentiment-maximumentropy}

\subsection{Support Vector Machine Classifier}
\label{ss:casestudy-sentiment-supportvector}
