...
\begin{table}
  \begin{tabular}[c]{!l ^r ^l ^l}
    \hline
    \rowstyle{\bfseries}
	  Company & \#cars \citep{OICA2016} & Stock Exchange & Symbol  \\ \hline
	  \ford{} & 6,429,485 & New York \citep{FordMotorCompany2018} & F  \\
	  \gm{} & 7,793,066 & New York \citep[p.17]{GeneralMotorsCompany2018} & GM \\
	  \hyundai{} & 7,889,538 & Korea \citep[p.92]{HyundaiMotorCompany2016} & 005380.KS \\
	  \toyota{} & 10,213,486 & Tokyo \citep{ToyotaMotorCorporation2018} & 7203.T \\
	  \vw{} & 10,126,281 & Frankfurt \citep[p.110]{VolkswagenAktiengesellschaft2017} & VOW.F \\  \hline
	\end{tabular}
